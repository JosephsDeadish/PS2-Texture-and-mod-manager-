...
class TestPnachAnalyzer(unittest.TestCase):
    ...
    def test_pnach_db_expanded(self):
        """Known addresses DB should have grown beyond 4500 entries (wave 26 expansion)."""
        from src.core.pnach_analyzer import reload_db
        n = reload_db()
        self.assertGreater(n, 4500, "PNACH DB should have more than 4500 entries after wave-26 expansion")
